...
<html lang="en">
  ...
  <body>
	  ...
	  <div class="collapse navbar-collapse" id="navbarCollapse">
		...
		<form:form class="form-inline mt-2 mt-md-0" action="login" commandName="login" role="form" method="GET">
	...
	<div class="row">
		...
		<div class="row">
				<div class="col-xs-12 col-sm-10 col-md-10 col-sm-offset-2 col-md-offset-3">
						...
						<form:form role="form" action="addBatch" commandName="batchAllocation" method="POST">
						<h2>Batch Allocation</h2>
						<hr/>
						
							<div class="card-body" style="background-color:#f5f5f5;">
							<div class="form-group">
							<form:input type="text" path="batchId" name="bid" id="Bid" class="form-control input-lg" placeholder="Batch ID" tabindex="1"/><br/>
							<form:input type="text" path="facultyId" name="fid" id="Fid" class="form-control input-lg" placeholder="Faculty ID" tabindex="1"/><br/>
							<p> New Close Date: <form:input type="date" name="nday" path="start_date"/><br/></p>
							<p>   End Date:&nbsp;  <form:input type="date" name="eday" path="end_date"/><br/></p>
							<p>   Close Date: <form:input type="date" name="cday" path="close_date"/><br/></p>
							</div>						
